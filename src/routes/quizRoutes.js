...
router.post('/',                 protect, restrictTo('admin', 'school_admin', 'super_admin', 'teacher'), quiz.createQuiz)
router.get('/:id',               protect, quiz.getQuiz)
router.patch('/:id',             protect, restrictTo('admin', 'school_admin', 'super_admin', 'teacher'), quiz.updateQuiz)
router.delete('/:id',            protect, restrictTo('admin', 'school_admin', 'super_admin', 'teacher'), quiz.deleteQuiz)
